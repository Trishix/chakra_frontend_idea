...
\hypersetup{colorlinks=true,linkcolor=teal,urlcolor=teal,pdftitle={CI Intel Technical Architecture Counter Questions}}
\pagestyle{fancy}\fancyhf{}\lhead{\textcolor{navy}{CI Intel TECHNICAL REVIEW}}\rhead{\textcolor{teal}{dot\_gitignore}}\cfoot{\thepage}\setlength{\headheight}{14pt}
